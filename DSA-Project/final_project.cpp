...
void deleteStore(string);
bool DisplayStores();
void addStore();
void sendMessageToSeller();
//-----------------------------------
void buyerMenu(); // buyer menu

void registerBuyer();
bool loginBuyer();
void purchaseProduct(const string &);
void giveRatingToStore(string); // abhi banana ha
void displayBuyerBalance(const string &);

//-------------------------------------
void sellerMenu(); // seller menu

void addProduct(string);
void UpdateProductsQuantity(string);
void displaySalesAndEarnings(const string&);
bool displayProducts(string);
void viewStoreRatings(string); // abhi banana ha.
void deleteProduct(string);
void viewMessagesForSeller(string);
...
struct Store
{
    ...
    int ratingCount;                       // Total number of ratings
    stack<string> messages;
};

// Global unordered_maps for buyers and stores
