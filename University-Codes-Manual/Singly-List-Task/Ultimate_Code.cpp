...
void SortSinglyList()
{
    ...
    if (head->next == nullptr)
    {
        ...
        cout << "Linked List Data -> " << head->data << endl;
        return;
    }
    ...
    cout << "List Sort Successfully!" << endl;
}
...
void DeleteDuplicatesFromSortedList()
{
    ...
    while (current != nullptr)
    {
        if (current->next != nullptr && current->data == current->next->data)
        {
            ...
            node *NodeToBeAttached = current->next->next;
            delete NodeToBeDeleted;
            current->next = NodeToBeAttached;
        }
        else
        {
            current = current->next;
...
void DeleteDuplicatesFromUnsortedList()
{
    node *current = head;
    ...
    {
        cout << "1 element only, no duplicates to remove!" << endl;
        return;
    }
    ...
    while (current != nullptr)
    {
        ...
        while (temp->next != nullptr)
        {
            if (current->data == temp->next->data)
            {
                ...
                delete NodeToBeDeleted;        // Delete the duplicate node
            }
            else
            {
...
int main()
{
    ...
    do
    {
        ...
        cout << "8. Delete Duplicates In sorted List!" << endl;
        cout << "9. Delete Duplicates In un-sorted List!" << endl;
        cout << "10. Exit" << endl;
        cout << endl;
        cout << "Enter your choice: ";
        cin >> condition;
        ...
        case 8:
            ...
            break;
        case 9:
            DeleteDuplicatesFromUnsortedList();
            break;
        case 10:
            exit(0);
            break;
